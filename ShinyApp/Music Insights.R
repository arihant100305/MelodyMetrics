    ...
    conditionalPanel(
      ...
      sidebarMenu(id = "analysisMenu",
                  ...
                  selectInput("decade", "Choose a Decade:", 
                              choices = c("All", "00s", "90s", "80s", "70s", "60s", "Happy", "Sad", "Love", "Dance"), 
                              selected = "All"),
                  h3("Select Feature1"),
                  selectInput("feature1", "Choose Feature1:", 
                              choices = c("Released", "Popularity", "acousticness", "danceability", "energy", 
                                          "instrumentalness", "liveness", "loudness", "speechiness", 
                                          "tempo", "valence"),
                              selected = "Popularity"),
                  h3("Select Feature2"),
                  selectInput("feature2", "Choose Feature2:", 
                              choices = c("Released", "Popularity", "acousticness", "danceability", "energy", 
                                          "instrumentalness", "liveness", "loudness", "speechiness", 
                                          "tempo", "valence"),
                  ...
                  radioButtons("analysis_type", "Select Analysis Type:", 
                               choices = c("Line Plot", "Scatter Plot", "Correlation Matrix", "Violin Plot", "Density Plot"),
                               selected = "Line Plot")
